...
using NtfsSharp.Files.Attributes.AttributeList;
...
namespace NtfsSharp
{
    public class Volume : IDisposable, IComparable, IComparable<Volume>, IEquatable<Volume>, IVolume
    {
        ...
        public Volume(IDiskDriver diskDriver)
        {
        ...
        /// <remarks>The MFT cannot be returned because <seealso cref="AttributeListItem"/> relies on the MFT property to get child attributes.</remarks>
